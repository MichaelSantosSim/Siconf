...
void LineField::reset(){
	_fieldInput->setText("");
}

void LineField::_setTemplate(){
	setTemplateText(Wt::WString::tr("field"));
}

void LineField::setEmptyValidator(){
...
void LineField::setValidator(Wt::WValidator* validator){
	_fieldInput->setValidator(validator);
}

bool LineField::validate(){
...
void LineField::_updateInvalidMessage(std::string message){
	_fieldInvalidMessage->setText(message);
}

void LineField::_updateLabel(std::string label){
